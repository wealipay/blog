  ...
  const makeParticles = (element: HTMLElement) => {
    ...
    for (let i = 0; i < particleCount; i++) {
      ...
      setTimeout(() => {
        ...
        particle.style.setProperty("--color", `var(--color-${p.color}, red)`);
...
export default function TabNav() {
  const items = [
    { label: "首页", href: "/" },
    { label: "列表", href: "/products" },
    { label: "领红包", href: "/tutorial" },
    { label: "文档", href: "/docs" },
    { label: "关于", href: "/about" }
  ];

  return (
    <div className="fixed flex  text-xl bottom-1 px-20 w-full  h-12 leading-12 justify-around items-center">
      <StarBorder as="div" thickness="2" color="red" speed="3s" className="">
        <GooeyNav
          items={items}
          particleCount={15}
